...
namespace Project.Forms
{
    public partial class ManageBill : Form
    {
        ...
        private void updateGridView()
        {
            ...
            //MessageBox.Show(Home.phoneCustomer);
            gridView.DataSource = db.Bills.Select(u => new { u.BillId, v = u.Total * (u.Voucher == null ? 1 : (double)(100 - u.Voucher.ratio) / 100), u.OrderTimeStart, u.Staff.FullName }).OrderByDescending(u => u.OrderTimeStart).ToList();
            ...
            if (gridView.RowCount > 0)
            {
                ...
                lbCustomer.Text = db.Bills.Find(gridView.Rows[0].Cells[0].Value.ToString()).Customer.FullName;
        ...
        private void gridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            lbCustomer.Text = db.Bills.Find(gridView.CurrentRow.Cells[0].Value).Customer.FullName;
        ...
        private void txCodeBill_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == 13)
            {
                ...
                {
                    MessageBox.Show("Không tồn tại hóa đơn đó");
                }
            }
